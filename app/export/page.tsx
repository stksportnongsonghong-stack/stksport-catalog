    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Noto Sans Thai','Sarabun',sans-serif" }}>
      ...
      <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: '36px 32px', width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <div style={{ width: 48, height: 48, background: 'linear-gradient(135deg,#22c55e,#15803d)', borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: 22, color: '#fff', margin: '0 auto 14px' }}>S</div>
          <div style={{ display: 'inline-block', background: '#22c55e', fontSize: 9, padding: '2px 10px', borderRadius: 3, fontWeight: 700, letterSpacing: 2, color: '#fff', marginBottom: 10 }}>ADMIN ONLY</div>
        ...
        {loginErr && <div style={{ color: '#6699ff', fontSize: 12, marginBottom: 12, padding: '8px 12px', background: 'rgba(34,197,94,0.1)', borderRadius: 5 }}>{loginErr}</div>}
        <button style={{ width: '100%', background: '#22c55e', color: '#fff', border: 'none', padding: '11px', borderRadius: 5, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 700, fontSize: 14 }}
    ...
    <div style={{ fontFamily: "'Noto Sans Thai','Sarabun',sans-serif", background: '#0a0a0a', minHeight: '100vh', color: '#f5f5f5' }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .tab:hover{color:#fff}.tab.on{color:#fff;border-bottom-color:#22c55e}
        ...
        .card:hover{border-color:rgba(34,197,94,0.5);transform:translateY(-2px)}
        .card.sel{border-color:#22c55e;box-shadow:0 0 0 2px rgba(34,197,94,0.25)}
        ...
        .card.sel .chk{background:#22c55e;border-color:#22c55e}
        ...
        .btn-r{background:#22c55e;color:#fff;border:none;padding:10px 18px;border-radius:5px;cursor:pointer;font-family:inherit;font-weight:700;font-size:13px;transition:background .18s}
        ...
        .pill:hover{border-color:#22c55e;color:#22c55e}.pill.on{background:#22c55e;border-color:#22c55e;color:#fff}
      ...
      <div style={{ background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '0 20px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 56 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ width: 28, height: 28, background: 'linear-gradient(135deg,#22c55e,#15803d)', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: 13, color: '#fff' }}>S</div>
        ...
        <div className="main-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 20, alignItems: 'start' }}>
          ...
          <div>
              ...
              <div style={{ display: 'flex', minWidth: 'max-content' }}>
                {TABS.map(t => (
                  <div key={t.id} className={`tab${tab === t.id ? ' on' : ''}`} onClick={() => setTab(t.id)}>
                    {t.label}
                    {t.badge && <span style={{ background: '#22c55e', color: '#fff', fontSize: 9, padding: '1px 5px', borderRadius: 8, fontWeight: 700, marginLeft: 5 }}>{t.badge}</span>}
                  </div>
                ))}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
              ...
              <span>เลือก <b style={{ color: '#22c55e' }}>{selected.size}</b></span>
